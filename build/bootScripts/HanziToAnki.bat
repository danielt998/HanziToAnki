...
set JARPATH=%APP_HOME%\lib\HanziToAnki-1.0.0.jar

@rem Execute HanziToAnki
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HANZI_TO_ANKI_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%HANZI_TO_ANKI_EXIT_CONSOLE%" exit 1
exit /b 1
